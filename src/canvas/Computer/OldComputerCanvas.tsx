...
import { Group, Object3DEventMap, Mesh } from 'three';

interface IOldComputerProps {
    texture?: string;
    rotationY?: { get: () => number };
}

const DemoComputer = (props: IOldComputerProps) => {
  ...
  useFrame(() => {
    if (group.current && props.rotationY) {
      group.current.rotation.y = props.rotationY.get();
    }
  });
